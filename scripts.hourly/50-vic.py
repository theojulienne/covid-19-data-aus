...
def parse_fulltext_post(body):
  ...
  tested = None
  m = re.match(r'.* (?P<tested>[\d,]+) (Victorians have been tested to date|tests have been conducted to date|tests have been completed|tests have been undertaken).*', body, re.MULTILINE | re.DOTALL)
  if m:
